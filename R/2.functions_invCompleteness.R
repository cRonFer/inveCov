## Functions ####
inventory_completeness <- function(data,
                                   dir_e,
                                   resolution, # grid resolution
                                   cell_shape,  # shape of cell ('hex', 'square') if NA square
                                   Records_t,
                                   Ratio_t,
                                   Slope_t,
                                   Completeness_t,
 ...
 # Study area shpfiles
  ...
  print(paste('There are ', nrow(est), ' well surveyed cells in the study area based on the chosen thresholds'))
  ...
  ggsave('completeness_thresholds.png', completn_thresholds,
         width = 12, height = 5)
